...
class _AllBoardComponentState extends State<AllBoardComponent> with AutomaticKeepAliveClientMixin<AllBoardComponent>{
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text("yotei", style: TextStyle(fontSize: 48, fontWeight: FontWeight.bold,fontFamily: "Assistant")),
          ),
              ...
              InkWell(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("${board.name}", style: TextStyle(
