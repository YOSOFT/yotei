...
class _BoardPageState extends State<BoardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < _listData.length; i++) {
      ...
      _lists[i].items.add(BoardItem(item: Container(
        margin: EdgeInsets.all(16),
        child: Text("Item-"+i.toString(), style: TextStyle(fontSize: 28, fontFamily: "Assistant"),)),));
    }
    return Scaffold(
      body: BoardView(
        lists: _lists,
    ...
    return BoardItem(
        ...
        item: Card(
          child: Padding(
            ...
            child: Text(itemObject.title, style: TextStyle(fontSize: 39, color: Colors.blue),),
          ),
        )
      );
  }
